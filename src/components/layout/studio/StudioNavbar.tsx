...
import { Search, Bell, Menu, X, Video, Plus, HelpCircle } from "lucide-react";
      ...
      <div className="px-4 flex h-full items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 glass-strong rounded-xl border-border/50 p-1">
              <DropdownMenuItem className="rounded-lg gap-3 py-2.5 focus:bg-primary/10 transition-colors">
