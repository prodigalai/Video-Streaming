...
const forYouStreams = [
  {
    ...
    creator: { id: "jazz_vibes", name: "JazzVibes", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=jazz" },
    viewers: 4521,
    category: "Music",
  },
  {
    ...
    creator: { id: "cozy_gamer", name: "CozyGamer", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=cozy" },
    viewers: 2890,
    category: "Gaming",
  },
  {
    ...
    creator: { id: "artful_soul", name: "ArtfulSoul", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=artful" },
    viewers: 1876,
    category: "Art",
  },
  {
    ...
    creator: { id: "night_owl", name: "NightOwl", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=nightowl" },
    viewers: 5432,
...
const recommendedVideos = [
  {
    ...
    creator: { id: "music_master", name: "MusicMaster", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=master" },
    duration: "18:45",
    views: 34000,
  },
  {
    ...
    creator: { id: "tech_vibes", name: "TechVibes", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=tech" },
    duration: "24:30",
    views: 67000,
  },
];
